...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpavgb ')
        assert_equal(myDisasm.infos.repr, 'vpavgb xmm25, xmm31, xmmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xe0')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpavgb ')
        assert_equal(myDisasm.infos.repr, 'vpavgb ymm25, ymm31, ymmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xe0')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpavgb ')
        assert_equal(myDisasm.infos.repr, 'vpavgb zmm25, zmm31, zmmword ptr [r14]')
