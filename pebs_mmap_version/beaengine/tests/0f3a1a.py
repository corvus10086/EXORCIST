...
class TestSuite:
    ...
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vinsertf32x8 zmm28, zmm16, ymmword ptr [r8], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x1a)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vinsertf32x8 ')
        assert_equal(myDisasm.infos.repr, 'vinsertf32x8 zmm24, zmm16, ymm24, 11h')
        ...
        assert_equal(myDisasm.infos.repr, 'vinsertf64x4 zmm28, zmm16, ymmword ptr [r8], 11h')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x1a)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vinsertf64x4 ')
        assert_equal(myDisasm.infos.repr, 'vinsertf64x4 zmm24, zmm16, ymm24, 11h')
