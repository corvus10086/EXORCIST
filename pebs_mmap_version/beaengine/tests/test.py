...
class TestSuite:
    ...
    def test_adcx(self):
        ...
        assert_equal(myDisasm.infos.Operand2.AccessMode, __READ)
    ...
    def test_VEX3Bytes(self):
        ...
        assert_equal(myDisasm.infos.Operand3.AccessMode, __READ)
    ...
    def test_blendvpd(self):
        ...
        assert_equal(myDisasm.infos.Operand4.AccessMode, __READ)
