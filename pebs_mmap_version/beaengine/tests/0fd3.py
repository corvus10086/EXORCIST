...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'psrlq xmm2, xmmword ptr [rax+44332211h]')
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlq ')
        assert_equal(myDisasm.infos.repr, 'vpsrlq xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlq ')
        assert_equal(myDisasm.infos.repr, 'vpsrlq ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlq ')
        assert_equal(myDisasm.infos.repr, 'vpsrlq xmm25, xmm31, xmmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xd3')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlq ')
        assert_equal(myDisasm.infos.repr, 'vpsrlq ymm25, ymm31, ymmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xd3')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpsrlq ')
        assert_equal(myDisasm.infos.repr, 'vpsrlq zmm25, zmm31, zmmword ptr [r14]')
