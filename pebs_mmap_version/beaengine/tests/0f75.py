...
class TestSuite:
    def test(self):
        ...
        myDisasm.read()
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xf75')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'pcmpeqw ')
        assert_equal(myDisasm.infos.repr, 'pcmpeqw xmm2, xmmword ptr [rax+44332211h]')
        ...
        assert_equal(myDisasm.infos.repr, 'vpcmpeqw xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpeqw ')
        assert_equal(myDisasm.infos.repr, 'vpcmpeqw ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x75')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpeqw ')
        assert_equal(myDisasm.infos.repr, 'vpcmpeqw xmm25, xmm31, xmmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x75')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpeqw ')
        assert_equal(myDisasm.infos.repr, 'vpcmpeqw ymm25, ymm31, ymmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x75')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpeqw ')
        assert_equal(myDisasm.infos.repr, 'vpcmpeqw zmm25, zmm31, zmmword ptr [r14]')
