...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpeqd ')
        assert_equal(myDisasm.infos.repr, 'vpcmpeqd xmm25, xmm31, xmmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x76')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpeqd ')
        assert_equal(myDisasm.infos.repr, 'vpcmpeqd ymm25, ymm31, ymmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x76')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpcmpeqd ')
        assert_equal(myDisasm.infos.repr, 'vpcmpeqd zmm25, zmm31, zmmword ptr [r14]')
