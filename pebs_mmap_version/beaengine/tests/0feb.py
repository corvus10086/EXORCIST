...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vpord xmm25, xmm31, xmmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xeb')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpord ')
        assert_equal(myDisasm.infos.repr, 'vpord ymm25, ymm31, ymmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xeb')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpord ')
        assert_equal(myDisasm.infos.repr, 'vpord zmm25, zmm31, zmmword ptr [r14]')
