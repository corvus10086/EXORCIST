...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vpandnd xmm25, xmm31, xmmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xdf')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpandnd ')
        assert_equal(myDisasm.infos.repr, 'vpandnd ymm25, ymm31, ymmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0xdf')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpandnd ')
        assert_equal(myDisasm.infos.repr, 'vpandnd zmm25, zmm31, zmmword ptr [r14]')
