...
class TestSuite:
    def test(self):
        ...
        assert_equal(myDisasm.infos.repr, 'vpdpwssd xmm25, xmm16, xmmword ptr [r14]')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x52)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpdpwssd ')
        assert_equal(myDisasm.infos.repr, 'vpdpwssd ymm25, ymm16, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.infos.Instruction.Opcode, 0x52)
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vpdpwssd ')
        assert_equal(myDisasm.infos.repr, 'vpdpwssd zmm25, zmm16, zmmword ptr [r14]')
        ...
        assert_equal(myDisasm.infos.repr, 'vp4dpwssd zmm25, zmm20...zmm23, xmmword ptr [r14]')
