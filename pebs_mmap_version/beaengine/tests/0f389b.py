...
class TestSuite:
    def test(self):
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ss xmm9, xmm15, xmmword ptr [r14]')
        ...
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ss ymm9, ymm15, ymmword ptr [r14]')
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ss xmm25, xmm31, xmmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x9b')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ss ymm25, ymm31, ymmword ptr [r14]')
        ...
        assert_equal(hex(myDisasm.infos.Instruction.Opcode), '0x9b')
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132ss ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132ss zmm25, zmm31, zmmword ptr [r14]')
        ...
        myDisasm = Disasm(Buffer)
        myDisasm.read()
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'vfmsub132sd ')
        assert_equal(myDisasm.infos.repr, 'vfmsub132sd xmm9, xmm15, xmmword ptr [r14]')
        ...
        assert_equal(myDisasm.infos.Instruction.Mnemonic, 'v4fmaddss ')
        assert_equal(myDisasm.infos.Operand2.Registers.zmm, REG20+REG21+REG22+REG23)
        assert_equal(myDisasm.infos.repr, 'v4fmaddss zmm25, zmm20...zmm23, xmmword ptr [r14]')
