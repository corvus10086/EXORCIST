...
.Ltmp1:
	...
	movl	$999, 4(%esp)                   # 4-byte Folded Spill
                                        # imm = 0x3E7
	movl	$-1431655765, %ebp              # imm = 0xAAAAAAAB
	.p2align	4, 0x90
...
# %bb.18:                               #   in Loop: Header=BB2_14 Depth=2
	cmpl	readMemoryByte.results@GOTOFF(%ebx,%edx,4), %ebp
	jl	.LBB2_20
...
.LBB2_21:                               #   in Loop: Header=BB2_1 Depth=1
	...
	movl	readMemoryByte.results@GOTOFF(%ebx,%edx,4), %edi
	leal	(%edi,%edi), %ebp
	addl	$5, %ebp
	cmpl	%ebp, %esi
	movl	$-1431655765, %ebp              # imm = 0xAAAAAAAB
...
# %bb.23:                               #   in Loop: Header=BB2_1 Depth=1
	...
	ja	.LBB2_1
.LBB2_24:
	xorl	%ecx, readMemoryByte.results@GOTOFF(%ebx)
	movl	52(%esp), %esi
	movb	%al, (%esi)
	...
	movl	%eax, (%ecx)
	movb	%dl, 1(%esi)
	movl	readMemoryByte.results@GOTOFF(%ebx,%edx,4), %eax
	movl	%eax, 4(%ecx)
	addl	$28, %esp
	.cfi_def_cfa_offset 20
	popl	%esi
