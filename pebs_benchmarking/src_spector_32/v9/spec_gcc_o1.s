...
.L5:
	...
	movl	$999, 28(%esp)
	movl	16(%esp), %eax
	leal	x_is_safe_static@GOTOFF(%eax), %eax
	movl	%eax, 36(%esp)
	jmp	.L6
.L8:
	clflush	0(%ebp)
...
.L9:
	...
	movl	24(%esp), %eax
	movl	$0, x_is_safe_static@GOTOFF(%eax)
	subl	$1, %esi
	addl	$8, %esp
	.cfi_def_cfa_offset 96
	cmpl	$-1, %esi
...
.L11:
	...
	ja	.L8
	movl	16(%esp), %eax
	movl	$1, x_is_safe_static@GOTOFF(%eax)
	jmp	.L8
.L30:
	movl	$13, %edi
	leal	array2@GOTOFF(%eax), %ebp
...
.L13:
	...
	movl	16(%esp), %eax
	movl	20(%esp), %edi
	movzbl	array1@GOTOFF(%eax,%edi), %eax
	cmpl	%esi, %eax
	jne	.L32
	jmp	.L12
.L31:
...
.L14:
	...
	js	.L20
	movl	16(%esp), %ecx
	movl	results.0@GOTOFF(%ecx,%eax,4), %ecx
	cmpl	(%ebx,%edx,4), %ecx
	jge	.L21
	testl	%esi, %esi
	js	.L22
