...
# %bb.8:                                #   in Loop: Header=BB2_7 Depth=2
	...
	movzx	eax, byte ptr [eax + edi + array2@GOTOFF]
...
# %bb.11:                               #   in Loop: Header=BB2_7 Depth=2
	add	dword ptr [ebx + 4*ebp + readMemoryByte.results@GOTOFF], 1
	jmp	.LBB2_12
	.p2align	4, 0x90
...
# %bb.16:                               #   in Loop: Header=BB2_14 Depth=2
	...
	cmp	edi, dword ptr [ebx + 4*eax + readMemoryByte.results@GOTOFF]
	jge	.LBB2_17
...
.LBB2_23:                               #   in Loop: Header=BB2_1 Depth=1
	mov	edx, dword ptr [ebx + 4*eax + readMemoryByte.results@GOTOFF]
...
# %bb.25:                               #   in Loop: Header=BB2_1 Depth=1
	...
	ja	.LBB2_1
.LBB2_26:
	xor	dword ptr [ebx + readMemoryByte.results@GOTOFF], ebp
