...
.L12:
	...
	mov	DWORD PTR 8[esp], eax
	mov	DWORD PTR 12[esp], edx
	cmp	ecx, DWORD PTR 8[esp]
	mov	eax, 0
	sbb	eax, DWORD PTR 12[esp]
	jc	.L11
	...
	cmp	eax, ebx
	je	.L11
	add	DWORD PTR results.0@GOTOFF[edi+ebx*4], 1
	jmp	.L11
.L30:
...
.L7:
	...
	jne	.L7
	mov	esi, DWORD PTR 16[esp]
	mov	ebx, DWORD PTR array1_size@GOTOFF[esi]
	mov	eax, DWORD PTR 20[esp]
	cdq
	idiv	ebx
	mov	edi, edx
	mov	ebp, 29
	lea	esi, array1_size@GOTOFF[esi]
	mov	ebx, 715827883
	jmp	.L10
.L16:
	mov	esi, DWORD PTR 16[esp]
