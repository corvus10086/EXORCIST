...
.Ltmp0:
	...
	mov	eax, dword ptr [ebp + 8]
	cmp	eax, dword ptr [ecx + array1_size@GOTOFF]
	jae	.LBB0_2
# %bb.1:
...
.Ltmp1:
	...
	mov	eax, dword ptr [ebp + 8]
	mov	eax, dword ptr [ebp + 8]
	mov	ecx, dword ptr [ecx + last_x@GOTOFF]
	cmp	eax, ecx
	jne	.LBB1_2
# %bb.1:
...
.LBB2_10:                               #   in Loop: Header=BB2_5 Depth=1
	...
	xor	edx, edx
	div	dword ptr [ecx + array1_size@GOTOFF]
...
# %bb.12:                               #   in Loop: Header=BB2_11 Depth=2
	mov	eax, dword ptr [ebp - 84]       # 4-byte Reload
	clflush	byte ptr [eax + last_x@GOTOFF]
...
.LBB2_21:                               #   in Loop: Header=BB2_19 Depth=2
	...
	cdq
	idiv	dword ptr [ecx + array1_size@GOTOFF]
