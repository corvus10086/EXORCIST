...
.L9:
	...
	add	DWORD PTR -76[ebp], 1
.L8:
	cmp	DWORD PTR -76[ebp], 255
	jle	.L9
	mov	DWORD PTR -80[ebp], 999
	jmp	.L10
.L31:
	mov	DWORD PTR -76[ebp], 0
	jmp	.L11
...
.L17:
	...
	shr	eax, 16
	or	DWORD PTR -52[ebp], eax
	mov	eax, DWORD PTR 8[ebp]
	xor	eax, DWORD PTR -64[ebp]
	and	eax, DWORD PTR -52[ebp]
	xor	eax, DWORD PTR -64[ebp]
	mov	DWORD PTR -52[ebp], eax
	cmp	DWORD PTR -52[ebp], 15
	ja	.L14
	mov	DWORD PTR x_is_safe_static@GOTOFF[ebx], 1
.L14:
	lea	eax, x_is_safe_static@GOTOFF[ebx]
...
.L15:
	...
	add	esp, 8
	mov	DWORD PTR x_is_safe_static@GOTOFF[ebx], 0
