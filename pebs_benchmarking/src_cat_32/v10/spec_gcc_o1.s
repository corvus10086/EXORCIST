...
.L32:
	...
	mov	eax, DWORD PTR results.0@GOTOFF[edx+esi]
	add	eax, 1
	mov	DWORD PTR results.0@GOTOFF[edx+esi], eax
.L14:
	add	DWORD PTR 8[esp], 1
	mov	eax, DWORD PTR 8[esp]
	cmp	eax, 256
	je	.L33
.L15:
...
.L34:
	...
	je	.L19
.L25:
	sub	DWORD PTR 20[esp], 1
	je	.L19
.L9:
	mov	eax, DWORD PTR 20[esp]
	mov	esi, DWORD PTR 12[esp]
	lea	edx, array2@GOTOFF[esi]
	lea	ecx, 131072[edx]
.L10:
	clflush	[edx]
	add	edx, 512
	...
	jne	.L10
	mov	esi, DWORD PTR 12[esp]
	mov	esi, DWORD PTR array1_size@GOTOFF[esi]
	cdq
	idiv	esi
	mov	ebx, edx
...
.L19:
	mov	esi, DWORD PTR 12[esp]
	mov	eax, DWORD PTR results.0@GOTOFF[esi]
