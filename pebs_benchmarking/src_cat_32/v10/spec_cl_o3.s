...
.LBB3_7:                                #   in Loop: Header=BB3_4 Depth=2
	...
	mov	al, byte ptr [ebx + ebp + array2@GOTOFF]
	rdtscp
	mov	dword ptr [esp + 12], ecx       # 4-byte Spill
	sub	eax, dword ptr [esp + 16]       # 4-byte Folded Reload
	sbb	edx, dword ptr [esp + 20]       # 4-byte Folded Reload
	mov	ecx, 50
	cmp	ecx, eax
	mov	eax, 0
	sbb	eax, edx
...
# %bb.15:                               #   in Loop: Header=BB3_11 Depth=2
	cmp	ebp, dword ptr [ebx + 4*ecx + readMemoryByte.results@GOTOFF]
	jl	.LBB3_17
...
.Ltmp4:
	...
	mov	dword ptr [esp + 24], eax       # 4-byte Spill
	mov	dword ptr [esp + 44], esi       # 4-byte Spill
	jmp	.LBB4_1
	.p2align	4, 0x90
...
.LBB4_10:                               #   Parent Loop BB4_1 Depth=1
                                        ...
                                        # =>      This Inner Loop Header: Depth=4
	clflush	byte ptr [ebx + ecx + array2@GOTOFF]
	clflush	byte ptr [ebx + ecx + array2@GOTOFF+512]
	clflush	byte ptr [ebx + ecx + array2@GOTOFF+1024]
	clflush	byte ptr [ebx + ecx + array2@GOTOFF+1536]
	clflush	byte ptr [ebx + ecx + array2@GOTOFF+2048]
	clflush	byte ptr [ebx + ecx + array2@GOTOFF+2560]
	clflush	byte ptr [ebx + ecx + array2@GOTOFF+3072]
	clflush	byte ptr [ebx + ecx + array2@GOTOFF+3584]
	add	ecx, 4096
	cmp	ecx, 131072
	jne	.LBB4_10
# %bb.11:                               #   in Loop: Header=BB4_9 Depth=3
	...
	mov	esi, edx
	mov	edi, edx
	xor	edi, dword ptr [esp + 52]       # 4-byte Folded Reload
	xor	eax, eax
	jmp	.LBB4_12
	.p2align	4, 0x90
...
.LBB4_18:                               #   in Loop: Header=BB4_9 Depth=3
	...
	mov	dword ptr [esp], -1             # 4-byte Folded Spill
	jmp	.LBB4_19
	.p2align	4, 0x90
.LBB4_26:                               #   in Loop: Header=BB4_19 Depth=4
	mov	dword ptr [esp], ecx            # 4-byte Spill
	mov	ecx, esi
.LBB4_31:                               #   in Loop: Header=BB4_19 Depth=4
	add	eax, 2
	add	edx, 8
	cmp	eax, 256
	je	.LBB4_32
...
.LBB4_32:                               #   in Loop: Header=BB4_9 Depth=3
	...
	jge	.LBB4_35
# %bb.33:                               #   in Loop: Header=BB4_9 Depth=3
	xor	eax, 2
	or	eax, edx
	je	.LBB4_35
