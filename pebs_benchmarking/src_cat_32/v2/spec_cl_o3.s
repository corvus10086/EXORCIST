...
.Ltmp2:
	...
	jbe	.LBB2_2
# %bb.1:
	mov	cl, byte ptr [eax + array2@GOTOFF]
	and	byte ptr [eax + temp@GOTOFF], cl
.LBB2_2:
	ret
.Lfunc_end2:
...
.LBB4_38:                               #   Parent Loop BB4_1 Depth=1
	...
	test	eax, eax
	jle	.LBB4_1
# %bb.7:                                #   in Loop: Header=BB4_38 Depth=2
	sub	esp, 8
	.cfi_adjust_cfa_offset 8
	lea	eax, [ebx + .L.str.6@GOTOFF]
	push	dword ptr [esp + 16]
	.cfi_adjust_cfa_offset 4
	push	eax
	.cfi_adjust_cfa_offset 4
...
.LBB4_41:                               #   Parent Loop BB4_1 Depth=1
	...
	jmp	.LBB4_12
	.p2align	4, 0x90
.LBB4_13:                               #   in Loop: Header=BB4_8 Depth=3
	mov	ebx, 13
	jmp	.LBB4_14
	.p2align	4, 0x90
.LBB4_17:                               #   in Loop: Header=BB4_14 Depth=4
	add	ebx, 167
	cmp	ebx, 42765
	je	.LBB4_18
.LBB4_14:                               #   Parent Loop BB4_1 Depth=1
	...
	rdtscp
	sub	eax, edi
	sbb	edx, dword ptr [esp]            # 4-byte Folded Reload
	mov	esi, 100
	cmp	esi, eax
	mov	eax, 0
	sbb	eax, edx
...
.LBB4_30:                               #   in Loop: Header=BB4_19 Depth=4
	...
	jmp	.LBB4_31
	.p2align	4, 0x90
.LBB4_32:                               #   in Loop: Header=BB4_8 Depth=3
	mov	eax, ecx
	mov	eax, dword ptr [ebx + 4*ecx + readMemoryByte.results@GOTOFF]
	...
	cmp	eax, esi
	jge	.LBB4_35
# %bb.33:                               #   in Loop: Header=BB4_8 Depth=3
	xor	eax, 2
	or	eax, edx
	je	.LBB4_35
# %bb.34:                               #   in Loop: Header=BB4_8 Depth=3
	mov	edx, dword ptr [esp + 12]       # 4-byte Reload
	lea	eax, [edx - 1]
	cmp	edx, 1
	mov	dword ptr [esp + 12], eax       # 4-byte Spill
	ja	.LBB4_8
.LBB4_35:                               #   in Loop: Header=BB4_38 Depth=2
	mov	eax, dword ptr [esp + 20]       # 4-byte Reload
	...
	test	edi, edi
	jle	.LBB4_37
# %bb.36:                               #   in Loop: Header=BB4_38 Depth=2
