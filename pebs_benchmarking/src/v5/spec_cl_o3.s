...
.LBB3_20:                               #   in Loop: Header=BB3_8 Depth=2
	xor	ecx, dword ptr [rip + results]
	mov	dword ptr [rip + results], ecx
	xor	ebp, ebp
	lea	rbx, [rip + .L.str.7]
	mov	eax, ecx
	sub	eax, dword ptr [r12 + 4*rbp + 4]
	jle	.LBB3_24
	.p2align	4, 0x90
