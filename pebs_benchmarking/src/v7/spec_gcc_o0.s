...
.L9:
	cmp	DWORD PTR -104[rbp], 255
	jle	.L10
	mov	DWORD PTR -108[rbp], 999
	jmp	.L11
.L31:
	mov	QWORD PTR -88[rbp], 3
	mov	DWORD PTR -104[rbp], 0
	jmp	.L12
.L13:
	mov	eax, DWORD PTR -104[rbp]
