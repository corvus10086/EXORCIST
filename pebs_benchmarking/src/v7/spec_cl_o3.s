...
victim_function:                        # @victim_function
	.cfi_startproc
# %bb.0:
	movsxd	rax, dword ptr [rip + last_x]
	cmp	rax, rdi
	je	.LBB1_1
# %bb.2:
	cmp	rdi, 15
...
# %bb.0:
	...
	mov	r13, rdi
	lea	r12, [rip + readMemoryByte.results]
	mov	edx, 1024
	mov	rdi, r12
	xor	esi, esi
	call	memset@PLT
...
# %bb.8:                                #   in Loop: Header=BB2_7 Depth=2
	cmp	bpl, byte ptr [r8 + r10]
	je	.LBB2_10
# %bb.9:                                #   in Loop: Header=BB2_7 Depth=2
	mov	eax, ebx
	add	dword ptr [r12 + 4*rax], 1
	jmp	.LBB2_10
	.p2align	4, 0x90
...
# %bb.4:                                #   in Loop: Header=BB3_1 Depth=1
	...
	mov	esi, 1
	call	memset@PLT
	cmp	dword ptr [rsp + 36], 3         # 4-byte Folded Reload
	jne	.LBB3_6
...
.LBB3_10:                               #   Parent Loop BB3_1 Depth=1
	...
	clflush	byte ptr [rax + r13]
	clflush	byte ptr [rax + r13 + 512]
	clflush	byte ptr [rax + r13 + 1024]
	clflush	byte ptr [rax + r13 + 1536]
	clflush	byte ptr [rax + r13 + 2048]
	clflush	byte ptr [rax + r13 + 2560]
	clflush	byte ptr [rax + r13 + 3072]
	clflush	byte ptr [rax + r13 + 3584]
	add	rax, 4096
	cmp	rax, 131072
	jne	.LBB3_10
...
.LBB3_27:                               #   in Loop: Header=BB3_9 Depth=3
	movsxd	rbp, eax
	mov	edx, dword ptr [r12 + 4*rbp]
	movsxd	rax, r14d
	mov	esi, dword ptr [r12 + 4*rax]
	lea	edi, [rsi + rsi]
	add	edi, 5
	cmp	edx, edi
	mov	ebx, 2863311531
