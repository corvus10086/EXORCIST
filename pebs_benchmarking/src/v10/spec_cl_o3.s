...
.LBB3_2:                                #   Parent Loop BB3_1 Depth=1
	...
	clflush	byte ptr [rcx + r14 + 512]
	clflush	byte ptr [rcx + r14 + 1024]
	clflush	byte ptr [rcx + r14 + 1536]
	clflush	byte ptr [rcx + r14 + 2048]
	clflush	byte ptr [rcx + r14 + 2560]
	clflush	byte ptr [rcx + r14 + 3072]
	clflush	byte ptr [rcx + r14 + 3584]
	add	rcx, 4096
	cmp	rcx, 131072
	jne	.LBB3_2
...
.LBB4_10:                               #   Parent Loop BB4_1 Depth=1
                                        ...
                                        # =>      This Inner Loop Header: Depth=4
	clflush	byte ptr [rcx + rbx]
	clflush	byte ptr [rcx + rbx + 512]
	clflush	byte ptr [rcx + rbx + 1024]
	clflush	byte ptr [rcx + rbx + 1536]
	clflush	byte ptr [rcx + rbx + 2048]
	clflush	byte ptr [rcx + rbx + 2560]
	clflush	byte ptr [rcx + rbx + 3072]
	clflush	byte ptr [rcx + rbx + 3584]
	add	rcx, 4096
	cmp	rcx, 131072
	jne	.LBB4_10
...
.LBB4_12:                               #   Parent Loop BB4_1 Depth=1
                                        ...
                                        #           Child Loop BB4_13 Depth 5
                                        #             Child Loop BB4_35 Depth 6
	mov	byte ptr [rip + check_value], bpl
	mov	r12d, 29
	jmp	.LBB4_13
	.p2align	4, 0x90
...
.LBB4_26:                               #   in Loop: Header=BB4_9 Depth=3
	movsxd	r13, eax
	mov	edx, dword ptr [r8 + 4*r13]
	movsxd	rbp, r15d
	mov	esi, dword ptr [r8 + 4*rbp]
	lea	edi, [rsi + rsi]
	add	edi, 5
	cmp	edx, edi
...
.LBB4_29:                               #   in Loop: Header=BB4_8 Depth=2
	xor	dword ptr [rip + readMemoryByte.results], ecx
	mov	r12d, dword ptr [r8 + 4*r13]
	mov	ebp, dword ptr [r8 + 4*rbp]
	lea	eax, [rbp + rbp]
	cmp	r12d, eax
	lea	rsi, [rip + .L.str.8]
	lea	rax, [rip + .L.str.9]
