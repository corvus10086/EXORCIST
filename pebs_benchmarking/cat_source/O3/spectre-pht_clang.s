...
# %bb.0:
	...
	cmp	dword ptr [publicarray_size], ecx
	jbe	.LBB6_8
# %bb.1:
	mov	edx, ecx
	add	edx, -1
...
.LBB6_4:                                # =>This Inner Loop Header: Depth=1
	movzx	esi, byte ptr [eax + publicarray]
	movzx	ebx, byte ptr [esi + publicarray2]
	and	byte ptr [temp], bl
	add	eax, -1
	add	ecx, -1
	jne	.LBB6_4
.LBB6_5:
...
.LBB6_7:                                # =>This Inner Loop Header: Depth=1
	movzx	ecx, byte ptr [eax + publicarray-4]
	movzx	ecx, byte ptr [ecx + publicarray2]
	and	byte ptr [temp], cl
	movzx	ecx, byte ptr [eax + publicarray-5]
	movzx	ecx, byte ptr [ecx + publicarray2]
	and	byte ptr [temp], cl
	movzx	ecx, byte ptr [eax + publicarray-6]
	movzx	ecx, byte ptr [ecx + publicarray2]
	and	byte ptr [temp], cl
	movzx	ecx, byte ptr [eax + publicarray-7]
	movzx	ecx, byte ptr [ecx + publicarray2]
	and	byte ptr [temp], cl
	add	eax, -4
	cmp	eax, 3
