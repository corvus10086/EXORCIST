...
char *secret =
    ...
    "Ossifrage.testtesttesttesttesttesttestetsttesttesttettesttstete "
    "stetstetstteststsetttstttststtesttstetstse";
...
Analysis code
********************************************************************/
#define CACHE_HIT_THRESHOLD (25) /* assume cache hit if time <= threshold */
