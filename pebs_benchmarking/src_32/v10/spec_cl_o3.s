...
.LBB4_10:                               #   Parent Loop BB4_1 Depth=1
                                        ...
                                        # =>      This Inner Loop Header: Depth=4
	clflush	array2@GOTOFF(%ebx,%ecx)
	clflush	array2@GOTOFF+512(%ebx,%ecx)
	clflush	array2@GOTOFF+1024(%ebx,%ecx)
	clflush	array2@GOTOFF+1536(%ebx,%ecx)
	clflush	array2@GOTOFF+2048(%ebx,%ecx)
	clflush	array2@GOTOFF+2560(%ebx,%ecx)
	clflush	array2@GOTOFF+3072(%ebx,%ecx)
	clflush	array2@GOTOFF+3584(%ebx,%ecx)
...
# %bb.11:                               #   in Loop: Header=BB4_9 Depth=3
	...
	movl	%edx, %esi
	movl	%edx, %edi
	xorl	52(%esp), %edi                  # 4-byte Folded Reload
	xorl	%eax, %eax
	jmp	.LBB4_12
	.p2align	4, 0x90
